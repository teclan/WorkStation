var BMapLib = window.BMapLib = BMapLib || {}, BMAP_DRAWING_MARKER = "marker", BMAP_DRAWING_POLYLINE = "polyline", BMAP_DRAWING_CIRCLE = "circle", BMAP_DRAWING_RECTANGLE = "rectangle", BMAP_DRAWING_POLYGON = "polygon";
!function () {
    function e() {
    ...
    function t(e, t) {
        this.drawingManager = e, t = this.drawingToolOptions = t || {}, this.defaultAnchor = BMAP_ANCHOR_TOP_LEFT, this.defaultOffset = new BMap.Size(10, 10), this.defaultDrawingModes = [BMAP_DRAWING_MARKER, BMAP_DRAWING_CIRCLE, BMAP_DRAWING_POLYLINE, BMAP_DRAWING_POLYGON, BMAP_DRAWING_RECTANGLE], this.drawingModes = t.drawingModes ? t.drawingModes : this.defaultDrawingModes, t.anchor && this.setAnchor(t.anchor), t.offset && this.setOffset(t.offset)
    }
    ...
    !function () {
        window[i.guid] = {}, i.extend = function (e, t) {
            ...
            if (i.lang.isFunction(t))t = t.hashCode; else if (!i.lang.isString(t))return;
            ...
            var n, o = this.__listeners, a = e.type;
            if (e.target = e.target || this, e.currentTarget = this, 0 != a.indexOf("on") && (a = "on" + a), i.lang.isFunction(this[a]) && this[a].apply(this, arguments), "object" == typeof o[a])for (n in o[a])o[a][n].apply(this, arguments);
            return e.returnValue
        }, i.lang.inherits = function (e, t, n) {
            var i, o, a = e.prototype, s = new Function;
            ...
            var o, a = function (t) {
                n.call(e, t)
            }, s = i.event._listeners, r = i.event._eventFilter, l = t;
    ...
    i.lang.inherits(o, i.lang.Class, "DrawingManager"), o.prototype.open = function () {
        return 1 == this._isOpen ? !0 : (n(this), this._open(), void 0)
    }, o.prototype.close = function () {
        return 0 == this._isOpen ? !0 : (this._close(), void 0)
        ...
        n.enableCalculate === !0 ? this.enableCalculate() : this.disableCalculate(), this._isOpen = !(n.isOpen !== !0), this._isOpen && this._open(), this.markerOptions = n.markerOptions || {}, this.circleOptions = n.circleOptions || {}, this.polylineOptions = n.polylineOptions || {}, this.polygonOptions = n.polygonOptions || {}, this.rectangleOptions = n.rectangleOptions || {}
        ...
        var e = this, t = this._map, n = this._mask, i = function (n) {
        ...
        var e = this, t = this._map, n = this._mask, o = null, a = null, s = function (s) {
            a = s.point, o = new BMap.Circle(a, 0, e.circleOptions), t.addOverlay(o), n.enableEdgeMove(), n.addEventListener("mousemove", r), i.on(document, "mouseup", l)
        }, r = function (t) {
        ...
        var e = this, t = this._map, n = this._mask, o = null, a = null, s = function (s) {
            ...
            var t = e._calculate(o, o.getPath()[2]);
            e._dispatchOverlayComplete(o, t), a = null, n.disableEdgeMove(), n.removeEventListener("mousemove", r), i.un(document, "mouseup", l)
        };
        n.addEventListener("mousedown", s)
    }, o.prototype._calculate = function (e, t) {
        var n = {data: 0, label: null};
        if (this._enableCalculate && BMapLib.GeoUtils) {
            var i = t, o = !1, a = e.toString();
            switch (a) {
                case"[object Polyline]":
                    n.data = BMapLib.GeoUtils.getPolylineDistance(e);
                    break;
                case"[object Polygon]":
                    n.data = BMapLib.GeoUtils.getPolygonArea(e), i = e.getBounds().getCenter(), o = !0;
                    break;
                case"[object Circle]":
                    i = e.getCenter(), o = !0;
                    var s = e.getRadius();
            ...
            n.data = !n.data || n.data < 0 ? 0 : n.data.toFixed(2), n.label = this._addLabel(i, formatCalculateResult(n.data, o))
        }
        return n
        ...
        var n = new BMap.Label(t, {position: e, offset: new BMap.Size(-45, -25)});
        return n.setStyle({
            borderColor: "#808080",
            color: "#333",
            backgroundColor: "#F4F4F4"
        }), this._map.addOverlay(n), n
        ...
        var n = {overlay: e, drawingMode: this._drawingType};
        ...
        var t = this;
        this._map = e;
        var n = this.container = document.createElement("div"), i = this._map.getSize();
        ...
        var e = this._map, t = e.pixelToPoint(new BMap.Pixel(0, 0)), n = e.pointToOverlayPixel(t);
        ...
        var n = this._map, i = this, o = n.pointToPixel(this.getDrawPoint(e)), a = t(e), s = a.x - o.x, r = a.y - o.y;
        ...
        this._panByX = this._panByY = 0, o.x <= 20 || o.x >= n.width - 20 || o.y <= 50 || o.y >= n.height - 10 ? (o.x <= 20 ? this._panByX = 8 : o.x >= n.width - 20 && (this._panByX = -8), o.y <= 50 ? this._panByY = 8 : o.y >= n.height - 10 && (this._panByY = -8), this._edgeMoveTimer || (this._edgeMoveTimer = setInterval(function () {
            n.panBy(i._panByX, i._panByY, {noAnimation: !0})
        ...
        var t = this._map, n = i.getTarget(e), o = e.offsetX || e.layerX || 0, a = e.offsetY || e.layerY || 0;
        ...
        var s = new BMap.Pixel(o, a), r = t.pixelToPoint(s);
        return r
    ...
    }, t.prototype._generalHtml = function () {
        var e = {};
        ...
        var t = function (t, n) {
            return '<a class="' + t + '" drawingType="' + n + '" href="javascript:void(0)" title="' + e[n] + '" onfocus="this.blur()"></a>'
        }, n = [];
        n.push(t("BMapLib_box BMapLib_hander", "hander"));
        for (var i = 0, o = this.drawingModes.length; o > i; i++) {
            var a = "BMapLib_box BMapLib_" + this.drawingModes[i];
            i == o - 1 && (a += " BMapLib_last"), n.push(t(a, this.drawingModes[i]))
        }
        return n.join("")
    }, t.prototype._setScale = function (e) {
        var t = 390, n = 50, i = -parseInt((t - t * e) / 2, 10), o = -parseInt((n - n * e) / 2, 10);
        ...
        var e = this;
        i.on(this.panel, "click", function (t) {
            var n = i.getTarget(t), o = n.getAttribute("drawingType");
            e.setStyleByDrawingMode(o), e._bindEventByDraingMode(o)
        })
    }, t.prototype.setStyleByDrawingMode = function (e) {
        if (e)for (var t = this.panel.getElementsByTagName("a"), n = 0, i = t.length; i > n; n++) {
            var o = t[n];
        ...
        "hander" == e ? t.close() : (t.setDrawingMode(e), t.open())
    };
    var a = []
}();