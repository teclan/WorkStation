...
(function (w,DOC) {
   ...
   /* $.browser = $.browser || {};
    ...
    w.util.browserVersion = [ false, util.browser.isFirefox,util.browser.isChrome, util.browser.isSafari, util.browser.isOpera, util.browser.isIE6, util.browser.isIE7, util.browser.isIE8,
        util.browser.isIE9,util.browser.isIE10,util.browser.isIE11, util.browser.isIE ].indexOf(true);
    w.util.sysVersion = [ 'windows', 'linux', 'macintosh', 'other' ][[ util.browser.isWindows,util.browser.isLinux, util.browser.isMac, true ] .indexOf(true)];
})(window, document);